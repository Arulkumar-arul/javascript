...
let highSalaryEmployees = employee_2.filter(function(employee) {
...
let employee103 = employee_2.find(function(employee) {
...
let totalSalary_1 = employee_2.reduce(function(total, employee) {
...
let highestPaid = employee_2.reduce(function(highest, employee) {
...
let sortedEmployees = employee_2.sort(function(a, b) {
...
let employeeNames = employee_2.map(function(employee) {
    return employee.name;
});
